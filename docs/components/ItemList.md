...
- `itemNameOptions` *object*\
  options passed along to [ItemName](./ItemName) via v-bind
- `indicatorByUri` *object*\
  object that maps item URIs to either color strings or boolean values
