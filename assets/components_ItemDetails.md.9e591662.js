import"./chunks/ItemName.aa105fd6.js";import"./chunks/ItemList.d4bf8f5e.js";import{I as k,a as g}from"./chunks/ItemDetails.f7a58867.js";import"./chunks/LoadingIndicator.383bc321.js";import"./chunks/Arrow.3916db28.js";import"./chunks/AutoLink.917c2d13.js";import"./chunks/ConceptTree.576375c3.js";import"./chunks/ItemSuggest.f4008f8f.js";import{v as y}from"./chunks/style.e065a504.js";import"./chunks/utils.a5bf753d.js";import{g as m,o as q,c as h,b as a,d as p,t as o,a as e,w as l,p as d,x as c,e as r}from"./app.5e7cbef3.js";import"./chunks/shared.3f0a6f78.js";import"./chunks/vue-scrollto.ec7616c3.js";const b=r('<h1 id="itemdetails" tabindex="-1">ItemDetails <a class="header-anchor" href="#itemdetails" aria-hidden="true">#</a></h1><p>Component to display details for a JSKOS item.</p><p>Uses <a href="./ItemName.html">ItemName</a>, <a href="./ItemList.html">ItemList</a>, <a href="./LicenseInfo.html">LicenseInfo</a>, <a href="./AutoLink.html">AutoLink</a>. Also uses <a href="./../utilities/dragAndDrop.html">dragAndDrop</a> and defines a dropzone for items. Dropped items will trigger the <code>select</code> event.</p><h2 id="props" tabindex="-1">Props <a class="header-anchor" href="#props" aria-hidden="true">#</a></h2><ul><li><code>item</code> (object) - JSKOS item (concept or concept scheme) <ul><li>required</li></ul></li><li><code>itemListOptions</code> (object) - options that are passed along to <a href="./ItemList.html">ItemList</a> via v-bind <ul><li>default: <code>{}</code></li></ul></li><li><code>showTabs</code> (boolean) - option whether to show ItemDetailsTabs <ul><li>default: <code>true</code></li></ul></li><li><code>showAncestors</code> (boolean) - option whether to show the item&#39;s ancestors <ul><li>default: <code>true</code></li></ul></li><li><code>showBroader</code> (boolean) - option whether to show the item&#39;s broader concepts <ul><li>default: <code>true</code></li></ul></li><li><code>showNarrower</code> (boolean) - option whether to show the item&#39;s narrower concepts <ul><li>default: <code>true</code></li></ul></li><li><code>dropzone</code> (boolean) - option whether the component is a drop zone for concepts <ul><li>default: <code>true</code></li></ul></li><li><code>draggable</code> (boolean) - whether item elements are draggable <ul><li>default: <code>true</code></li><li>This will also set <code>itemListOptions.draggable</code> if it&#39;s not set separately.</li></ul></li></ul><h2 id="slots" tabindex="-1">Slots <a class="header-anchor" href="#slots" aria-hidden="true">#</a></h2><ul><li><code>beforeName</code>: Content shown before the item&#39;s name.</li><li><code>afterName</code>: Content shown after the item&#39;s name.</li><li><code>additionalTabs</code>: Slot to add additional tabs (via <a href="https://github.com/gbv/jskos-vue-tabs" target="_blank" rel="noopener noreferrer">jskos-vue-tabs</a>) or absolutely positioned content for all tabs.</li></ul><h2 id="events" tabindex="-1">Events <a class="header-anchor" href="#events" aria-hidden="true">#</a></h2><ul><li><code>select</code><ul><li>Emitted when a concept is selected.</li><li>Parameter is an object with properties <code>item</code> (containing the clicked JSKOS concept) and <code>row</code> (containing a boolean which is <code>true</code> when the click was initiated via the row, not on the item directly).</li></ul></li></ul><h2 id="css-variables" tabindex="-1">CSS Variables <a class="header-anchor" href="#css-variables" aria-hidden="true">#</a></h2><ul><li><code>--jskos-vue-itemDetails-dropzone-bgCover</code> - background color for overlay which is shown when an item is being dragged over ItemDetails <ul><li>default: <code>#eeeeee99</code></li></ul></li></ul><h2 id="examples" tabindex="-1">Examples <a class="header-anchor" href="#examples" aria-hidden="true">#</a></h2><h3 id="default" tabindex="-1">Default <a class="header-anchor" href="#default" aria-hidden="true">#</a></h3>',13),f=a("div",{style:{position:"absolute",top:"0",right:"0"}}," \u{1F680} ",-1),v=a("div",{style:{position:"absolute",top:"0",right:"0"}}," \u2795 ",-1),D=r(`<div class="language-vue"><pre><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span> <span class="token attr-name">setup</span><span class="token punctuation">&gt;</span></span><span class="token script"><span class="token language-javascript">
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">&gt;</span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>p</span><span class="token punctuation">&gt;</span></span>
    ...
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>button</span><span class="token punctuation">&gt;</span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>button</span>
      <span class="token attr-name">@click</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>state.draggable = !state.draggable<span class="token punctuation">&quot;</span></span><span class="token punctuation">&gt;</span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>template</span><span class="token punctuation">&gt;</span></span>
</code></pre></div><h3 id="hide-tabs-and-show-them-next-to-component" tabindex="-1">Hide tabs and show them next to component <a class="header-anchor" href="#hide-tabs-and-show-them-next-to-component" aria-hidden="true">#</a></h3><p>Note: This works best when using a fixed width for ItemDetailsTabs (otherwise wrapping might change depending on the selected tab).</p>`,3),w={style:{display:"flex","flex-wrap":"wrap"}},T=r(`<div class="language-vue"><pre><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span> <span class="token attr-name">setup</span><span class="token punctuation">&gt;</span></span><span class="token script"><span class="token language-javascript">
